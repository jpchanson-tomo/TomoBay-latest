package com.tomoparts.tomoBay.test.unit.model.royalMail;
...
public class RoyalMailCSVGeneratorTest
{
	 ...
	 * 
	 * @see com.tomoparts.tomoBay.model.royalMail.RoyalMailCSVGenerator#generate(java.lang.String, java.lang.String, java.lang.String).
	 */
	@Test
	public final void testGenerate()
	{
		...
		try
		{
			csv.generate(External.Files.ROYAL_MAIL_CSV_NAME.get(), 
							External.Files.ROYAL_MAIL_CSV_PATH.get(), 
							"UTF-8");
		} 
		catch (IOException e)
		...
		try
		{
			Scanner fileReader = new Scanner(new File(External.Files.ROYAL_MAIL_CSV_FULL.get()));
