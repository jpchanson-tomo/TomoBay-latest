package com.tomoparts.tomoBay.helpers;
...
public enum Config
{
	...
	WIN_WEIGHT_CALL1("WINSTOCK_WEIGHT_CALL_PT1"),
	WIN_WEIGHT_CALL2("WINSTOCK_WEIGHT_CALL_PT2"),
	...
	RM_CSV_DEF("RM_CSV_DEF"),
	CSV_FIELD("CSV_FIELD"),
	CSV_FIELD_NAME("CSV_FIELD_NAME"),
	CSV_FIELD_VALID("CSV_FIELD_VALIDATION"),
	
	ROYAL_MAIL_USERNAME("RM_API_USERNAME"),
	ROYAL_MAIL_PASSWORD("RM_API_PASSWORD"),
	ROYAL_MAIL_APP_ID("RM_API_APP_ID"),
	ROYAL_MAIL_CLIENT_ID("RM_API_CLIENT_ID"),
	ROYAL_MAIL_CLIENT_SECRET("RM_API_CLIENT_SECRET"),
	ROYAL_MAIL_ENDPOINT("RM_API_ENDPOINT")
