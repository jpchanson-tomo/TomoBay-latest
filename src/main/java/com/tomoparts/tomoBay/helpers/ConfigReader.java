...
//	private static final String CONFIG_PATH = "./src/main/resources/config/";
	private static final String CONFIG_PATH = External.Files.CONFIG_PATH.get();
	/**
	 * Default ctor
	 */
	public ConfigReader()
	...
	{
		String stringToParse = ConfigReader.getConfig(ConfigReader.CONFIG_PATH, "tomoBay.conf", "UTF-8");
