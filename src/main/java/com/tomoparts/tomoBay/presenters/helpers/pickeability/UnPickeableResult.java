 ...
 *
 */
public final class UnPickeableResult extends Result<PickeableStatus>
{
	...
	public UnPickeableResult(Set<Boolean> itemStatus, String orderNo, Conditional<PickeableStatus> nextHandler)
	{
		super();
	...
	{return PickeableStatus.UNPICKEABLE;}
	...
	{
		Condition nextCondition = new PartialPickeable(this.itemStatus_M);
		Result<PickeableStatus> nextResult = new PartialPickeableResult(this.itemStatus_M, 
																						this.orderNo_M, 
																						this.nextHandler_M);
