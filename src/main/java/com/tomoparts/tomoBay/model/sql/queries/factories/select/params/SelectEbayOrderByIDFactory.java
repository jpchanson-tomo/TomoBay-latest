...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.select.params.SelectEbayOrderByID;
/**
 *
 * @author Jan P.C. Hanson
 *
 */
public final class SelectEbayOrderByIDFactory implements AbstractSelectParamsQueryFactory
{
	...
	{
		return new SelectEbayOrderByID();
	}
