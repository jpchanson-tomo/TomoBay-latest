...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.select.noParams.SelectEbayItems;

/**
 * creates a SelectEbayItems query object
 * @see {@link tomoBay.model.sql.queries.concreteQueries.select.noParams.SelectEbayItems}
 * @author Jan P.C. Hanson
 *
 */
public final class SelectEbayItemsFactory implements AbstractSelectNoParamsQueryFactory
{
	/**
	 * default ctor
	 */
