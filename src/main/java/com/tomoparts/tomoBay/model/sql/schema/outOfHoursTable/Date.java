package com.tomoparts.tomoBay.model.sql.schema.outOfHoursTable;
...
/**
 * This class represents the date field of the out_of_hours table in the database
 * - Type: DATE
 * - Size: N/A
 * 
 ...
 *
 */
public final class Date implements AbstractField
{
