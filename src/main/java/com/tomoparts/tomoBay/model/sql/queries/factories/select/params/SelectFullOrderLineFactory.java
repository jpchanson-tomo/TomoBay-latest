...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.select.params.SelectFullOrderLine;
/**
 *
 * @author Jan P.C. Hanson
 *
 */
public final class SelectFullOrderLineFactory implements AbstractSelectParamsQueryFactory
{
	/**
	 * default ctor
	 */
	public SelectFullOrderLineFactory()
	{super();}
	...
	{
		return new SelectFullOrderLine();
	}
