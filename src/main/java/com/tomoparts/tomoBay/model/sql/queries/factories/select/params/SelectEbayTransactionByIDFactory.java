...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.select.params.SelectEbayTransactionByID;
/**
 *
 * @author Jan P.C. Hanson
 *
 */
public final class SelectEbayTransactionByIDFactory implements AbstractSelectParamsQueryFactory
{
	...
	{
		return new SelectEbayTransactionByID();
	}
