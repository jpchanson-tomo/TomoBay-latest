...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.select.noParams.SelectUninvoicedOrders;
/**
 * creates a SelectUninvoicedOrders query object
 * @see {@link tomoBay.model.sql.queries.concreteQueries.select.noParams.SelectUninvoicedOrders}
 * @author Jan P.C. Hanson
 *
 */
public final class SelectUninvoicedOrdersFactory implements AbstractSelectNoParamsQueryFactory
{
	/**
	 * default ctor
	 */
	...
	{
		return new SelectUninvoicedOrders();
	}
