...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.update.UpdateInvoiceStatus;

/**
 * Creates an UpdateInvoiceStatus query object
 * @see {@link tomoBay.model.sql.queries.concreteQueries.update.UpdateInvoiceStatus}
 * @author Jan P.C. Hanson
 *
 */
public final class UpdateInvoiceStatusFactory implements AbstractModifyQueryParamsFactory
{
	/**
	 * default ctor
	 */
	public UpdateInvoiceStatusFactory()
	{super();}
