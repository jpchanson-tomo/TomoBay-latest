...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.update.UpdateItemBrandAndPartNo;
/**
 * create an UpdateItemBrandAndPartNo query object
 * @see {@link tomoBay.model.sql.queries.concreteQueries.update.UpdateItemBrandAndPartNo}
 * @author Jan P.C. Hanson
 *
 */
public final class UpdateItemBrandAndPartNoFactory implements AbstractModifyQueryParamsFactory
{
	/**
	 * default ctor
	 */
	public UpdateItemBrandAndPartNoFactory()
	{super();}
	...
	{return new UpdateItemBrandAndPartNo();}
}