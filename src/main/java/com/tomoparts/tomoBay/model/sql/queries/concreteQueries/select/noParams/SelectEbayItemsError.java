 ...
 *
 */
public  final class SelectEbayItemsError extends AbstractSelectNoParamsQuery
{
	/**SQL query string**/
	private static final String query ="SELECT * FROM ebay_items WHERE notes LIKE '%ERROR%';";
	//
	/**
	 * default constructor
	 */
	public SelectEbayItemsError()
	{super();}
	...
	{return SelectEbayItemsError.query;}
}