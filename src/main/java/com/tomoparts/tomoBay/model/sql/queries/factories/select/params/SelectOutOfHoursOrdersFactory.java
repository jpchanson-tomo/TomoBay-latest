...
import com.tomoparts.tomoBay.model.sql.queries.concreteQueries.select.params.SelectOutOfHoursOrders;
/**
 *
 * @author Jan P.C. Hanson
 *
 */
public final class SelectOutOfHoursOrdersFactory implements AbstractSelectParamsQueryFactory
{
	...
	{
		return new SelectOutOfHoursOrders();
	}
