...
/**
 * the county field of the ebay_buyers table in the database. i.e. the county that the buyer lives in.
 * - Type: VARCHAR
 * - Size: 80
 * @author Jan P.C. Hanson
 *
 */
public class County implements AbstractField
{
