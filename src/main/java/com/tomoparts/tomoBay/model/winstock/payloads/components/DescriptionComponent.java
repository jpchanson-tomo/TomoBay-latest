package com.tomoparts.tomoBay.model.winstock.payloads.components;
 ...
 *
 */
public final class DescriptionComponent extends AbstractPayloadComponent
{
	...
	public List<Byte> convert(String input) throws PayloadException
	{
		...
		{throw new PayloadException("Description too long: " + input.length()+"/"+LENGTH);}
	}
}
