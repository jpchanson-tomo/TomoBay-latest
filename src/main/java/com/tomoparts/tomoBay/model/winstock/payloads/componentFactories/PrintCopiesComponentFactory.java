...
import com.tomoparts.tomoBay.model.winstock.payloads.components.PrintCopiesComponent;
 ...
 *
 */
public final class PrintCopiesComponentFactory implements AbstractComponentFactory
{
	...
	{
		return new PrintCopiesComponent();
	}
